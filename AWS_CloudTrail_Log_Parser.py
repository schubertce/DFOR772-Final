...
class AWSCloudTrailLogParserIngestModule(DataSourceIngestModule):
    ...
    def process(self, dataSource, progressBar):
        ...
        # Identify CloudTrail log files to analyze
        ...
        for file in files:
            ...
            # Store content of log in variable
            log_content = []
            ...
            # Parse and store data from logs into variables
            try:
                ...
                for event in log_data["Records"]:
                    ...
                    # Add data to attributes in Autopsy
                    attributes.add(
